...
const Login = () => {
  ...
  return (
    <div
      className="h-screen flex justify-center items-center px-4" // Agregamos px-4 para espacio en los laterales
      style={{
    ...
    >
      <div className="bg-green-900 p-8 rounded-lg shadow-lg max-w-md w-full md:max-w-lg h-[80vh] md:h-[80vh]"> {/* Altura ajustada */}
