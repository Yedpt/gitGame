      ...
      <main className="pt-16">
        ...
        <section className="relative h-64 md:min-h-screen md:flex items-center justify-center overflow-hidden">
          ...
          <div className="z-0 text-center relative px-4 md:px-0">
            <h2 className="text-2xl md:text-4xl font-bold mb-2 font-title mt-8 md:mt-2">
              Bienvenido a
            </h2>
            <img
              src={logo}
        ...
        <section className="p-8">
          <h2 className="text-4xl md:text-6xl md:mb-14 font-bold my-10 text-greenLight font-title">
            NOTICIAS DESTACADAS
          </h2>
        ...
        <section className="p-8 md:mt-16">
          <h2 className="md:text-5xl text-3xl font-bold mb-8 text-greenLight  font-title">
            SOBRE NOSOTROS
          </h2>
          <div className="flex flex-col md:flex-row items-center md:items-stretch">
            ...
            <div className="md:w-1/2 mb-6 md:mb-0 md:pr-8 flex flex-col justify-center">
              <p className="mb-4 font-paragraph md:font-extralight text-base md:text-lg leading-relaxed md:leading-normal">
                Somos un grupo apasionado por los videojuegos, dedicados a
                compartir nuestras experiencias y conocimientos con la comunidad
                gamer. Nuestro objetivo es mantenerte informado sobre las
                últimas novedades, análisis y noticias en el fascinante mundo de
                los videojuegos.
                <br />
                <br />
                Nos comprometemos a proporcionarte información actualizada,
                análisis detallados y contenido exclusivo sobre tus videojuegos
                favoritos y los próximos lanzamientos, para que siempre estés al
                día con lo mejor de la industria del entretenimiento digital.
                <br />
                <br />
                Valoramos la inclusión y el respeto en nuestra comunidad, por lo
                que invitamos a todos los amantes de los videojuegos a unirse a
                nosotros, siempre que sea con respeto y transparencia.
                ¡Bienvenidos a nuestro espacio gamer!
              </p>
            </div>
        ...
        <section className="p-4 mt-14 sm:p-8">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-10 max-w-8xl mx-auto">
            ...
            <div className="lg:w-1/2 w-full">
              <p className=" md:text-lg text-base font-paragraph font-medium mb-8">
                Si tienes alguna idea, retroalimentación o pregunta, no dudes en
                contactar. Tu opinión e ideas son muy importantes para todos
                nosotros.
              </p>
              ...
              <form className="space-y-6">
                <div>
                  <input
                    ...
                    type="text"
                    placeholder="Nombre"
                    className="w-full p-3 bg-greenMid text-light rounded-xl placeholder-light focus:outline-none focus:ring-2 focus:ring-greenLight text-base"
                    required
                  />
                </div>
                <div>
                ...
                <div>
                  <textarea
                    ...
                    rows={6}
                    className="w-full p-3 bg-greenMid text-light rounded-xl placeholder-light focus:outline-none focus:ring-2 focus:ring-greenLight resize-y text-base"
                    required
                  ></textarea>
                </div>
