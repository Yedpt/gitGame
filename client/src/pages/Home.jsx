export default function App() {
  return (
    <div className="min-h-screen" style={{ backgroundColor: '#2D342D', color: 'white' }}>
      <main className="pt-16">
        <section className="relative h-[500px] flex items-center justify-center overflow-hidden">
          ...
          <div className="relative z-10 text-center">
            ...
            <h3 className="text-8xl font-bold text-green-500 shadow-text font-title">GG GAME</h3>
          </div>
        </section>
        ...
        <section className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 row-span-3 bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2">
              ...
              <div className="p-4">
                <h3 className="text-2xl font-bold mb-2 font-title">El nuevo Call of Duty vuelve a sus orígenes</h3>
            ...
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2">
              ...
              <div className="p-4">
                <h3 className="text-xl font-bold mb-2 font-title">Diablo 4 se estrena con éxito</h3>
              </div>
            </div>
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2">
              <img src="/placeholder.svg?height=200&width=400" alt="GTA 6" className="w-full h-48 object-cover" />
              <div className="p-4">
                <h3 className="text-xl font-bold mb-2 font-title">GTA 6 saldría a la venta en 2025</h3>
              </div>
            </div>
            <div className="bg-gray-800 rounded-lg overflow-hidden shadow-lg transition-transform duration-300 hover:-translate-y-2">
              <img src="/placeholder.svg?height=200&width=400" alt="New RPG" className="w-full h-48 object-cover" />
              <div className="p-4">
                <h3 className="text-xl font-bold mb-2 font-title">Nuevo RPG anunciado por estudio indie</h3>
              </div>
            </div>
          </div>
        </section>
